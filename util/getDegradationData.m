...
degSampleNum_per_sim = 25; % to avoid COMSOL process abruptly killed by Linux kernel for taking long memeory
...
for partition_idx = 1:deglifePartitions_num
    ...
    cellSimParams.cell_1C_capacityInAh = cell_1C_capacityInAh;
    cellSimParams.cell_nominalVoltage = cell_nominalVoltage;
